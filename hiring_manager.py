#Karina
#Create a function that takes in a number for years of experience, a word for expertise and shows all candidates that meet the criteria
...
def hiring(years,title ):
    for i in range(len(expertise)):
        #Step 2 (THE conditional statement)
        if experience[i]>years and expertise[i]==title:
...
hiring(0,"Python Developer")
hiring(5,"Cyber Security")
