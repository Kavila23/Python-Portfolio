...
#Functions
#This function takes a grocery item and prints or RETURNS its price
...
discount(0.20)
price_check("Frozen Waffles")
price_check("Coffee")
price_check("Sugar")
price_check("Maple Syrup")
price_check("Butter")
filter(2)
print(1+2+0.5+1.4+0.8)
